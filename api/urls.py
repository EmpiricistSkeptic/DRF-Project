...
from .viewsets import (
    ...
    GroupMessageViewSet,
    NotificationViewSet,
    ConsumedCaloriesViewSet,
    UserNutritionGoalViewSet,
    AchievementViewSet,
...
router.register(
    r"consumed-calories", ConsumedCaloriesViewSet, basename="consumed-calories"
)
router.register(
    r"nutrition-goals", UserNutritionGoalViewSet, basename="nutrition-goals"
)
