    ...
    def handle(self, *args, **options):
        ...
        categories = {
            "english": Category.objects.get_or_create(
                name="English", defaults={"description": "Learning English language"}
            )[0],
            ...
            "reading": Category.objects.get_or_create(
                name="Reading", defaults={"description": "Reading books and articles"}
            )[0],
            "coding": Category.objects.get_or_create(
                name="Coding", defaults={"description": "Programming and development"}
            )[0],
        }
        ...
        unit_types = {
            "hours": UnitType.objects.get_or_create(
                name="Hours", defaults={"symbol": "h"}
            )[0],
            "minutes": UnitType.objects.get_or_create(
                name="Minutes", defaults={"symbol": "min"}
            )[0],
            "words": UnitType.objects.get_or_create(
                name="Words", defaults={"symbol": "words"}
            )[0],
            "pages": UnitType.objects.get_or_create(
                name="Pages", defaults={"symbol": "pg"}
            )[0],
            "hits": UnitType.objects.get_or_create(
                name="Hits", defaults={"symbol": "hits"}
            )[0],
            "exercises": UnitType.objects.get_or_create(
                name="Exercises", defaults={"symbol": "ex"}
            )[0],
            "problems": UnitType.objects.get_or_create(
                name="Problems", defaults={"symbol": "prob"}
            )[0],
        }
